...
exports.getUserOrders = (req, res) => {
  ...
  alipay.orderList(options).then(success => {
    res.send(success);
  }).catch(err => {
    console.log(err);
    res.status(403).end();
...
exports.getPaypalUserOrders = (req, res) => {
  ...
  paypal.orderList(options).then(success => {
    res.send(success);
  }).catch(err => {
    console.log(err);
    res.status(403).end();
...
exports.getOrders = (req, res) => {
  ...
  alipay.orderListAndPaging(options).then(success => {
    res.send(success);
  }).catch(err => {
    console.log(err);
    res.status(403).end();
...
exports.getPaypalOrders = (req, res) => {
  ...
  options.filter = req.query.filter || '';
  paypal.orderListAndPaging(options).then(success => {
    res.send(success);
  }).catch(err => {
    console.log(err);
    res.status(403).end();
